...
/**
 * Class for all possible actions in JIRA API
 */
public class HTTPMethods {
    ...
    public static ValidatableResponse post(String urlPath, IssueInterface body) {
        ValidatableResponse response = given().
                header("Content-Type", ContentType.JSON).
                header("Cookie", "JSESSIONID=" + Authorization.JSESSIONID).
                body(body).
    ...
    logger.info("RESPONSE URL: " + Authorization.BASE_URI + urlPath);
    logger.info("RESPONSE BODY: " + responseBody);
    logger.info("REQUEST BODY: " + JiraJsonObjectHelper.extractJson(body));
        return response;
    }
